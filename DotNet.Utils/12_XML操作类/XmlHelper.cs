...
namespace DotNet.Utils
{
    ...
    public class XmlHelper
    {
        ...
        /// <returns></returns>
        public XmlNodeList GetAllChildNodes(string nodeName)
        {
            //创建XML的根节点
            CreateXMLElement();
            //返回XPath节点的值
            return _element.SelectSingleNode(nodeName).ChildNodes;
        }
        #endregion

        #region  获取指定节点的,指定子节点,指定属性
        /// <summary>
        /// 获取指定节点的,指定子节点,指定属性
        /// </summary>
        /// <param name="nodeName">节点名称</param>
        /// <param name="childNodeName">子节点名称</param>
        /// <param name="childNodeAttributesName">指定属性</param>
        /// <returns></returns>
        public string GetChildNodesAttributes(string nodeName, string childNodeName, string childNodeAttributesName)
        {
            //创建XML的根节点
            CreateXMLElement();
            //返回XPath节点的值
            XmlNodeList xnl = GetAllChildNodes(nodeName);
            foreach (XmlNode node in xnl)
            {
                if (node.Attributes["Name"].Value == childNodeName)
                {
                    return node.Attributes[childNodeAttributesName].Value;
                }
            }
            return "";
        }
